...
export default class UserProfile extends Component {
    ...
    if (this.state.isfavourite == true) {
      Api.toggleFavourite(user_id)
        .then(res => {
          ...
          Toast.show('UnFavourited Successfully', {
            duration: Toast.durations.LONG,
            position: Toast.positions.BOTTOM,
          });
        })
      ...
      Api.toggleFavourite(user_id)
        .then(res => {
          this.setState({isfavourite: true});
          Toast.show('Favourited Successfully', {
            duration: Toast.durations.LONG,
            position: Toast.positions.BOTTOM,
          });
        })
    ...
    if (this.state.isBlocked == true) {
      Api.toggleBlocked(user_id)
        .then(res => {
          ...
          Toast.show('UnBlocked Sucessfully', {
            duration: Toast.durations.LONG,
            position: Toast.positions.BOTTOM,
          });
        })
      ...
      Api.toggleBlocked(user_id)
        .then(res => {
          ...
          Toast.show('Blocked Sucessfully', {
            duration: Toast.durations.LONG,
            position: Toast.positions.BOTTOM,
          });
        })
  ...
  render() {
    ...
    const {advantages, about, family, hobbies, work, goals, seeking} = personal;
